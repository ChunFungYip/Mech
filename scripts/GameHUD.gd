...
func _build_ui() -> void:
    ...
    _panel(root, Vector2(24.0, 24.0), Vector2(330.0, 126.0), Color(0.018, 0.035, 0.05, 0.90))
    _label(root, "HONGONG MECH // NEON HARBOUR", Vector2(42.0, 38.0), Vector2(300.0, 24.0), 16, Color(0.45, 0.92, 0.92))
    _label(root, "HK-05 TITAN // PILOT LINK ACTIVE", Vector2(42.0, 63.0), Vector2(300.0, 20.0), 12, Color(0.70, 0.75, 0.76))
    _stats_label = _label(root, "ARMOR  500 / 500\nMACHINE GUN  60 / 240\nROCKETS  06 / 12", Vector2(42.0, 88.0), Vector2(300.0, 58.0), 15, Color(1.0, 0.78, 0.35))
    ...
    _label(root, "WASD MOVE     SHIFT BOOST     LMB MACHINE GUN     RMB ROCKET     R RELOAD", Vector2(42.0, 658.0), Vector2(550.0, 24.0), 11, Color(0.72, 0.78, 0.78))
...
func _process(delta: float) -> void:
    ...
    _stats_label.text = "ARMOR  %03d / %03d\nMACHINE GUN  %02d / %03d\nROCKETS  %02d / %02d" % [health, health_max, machinegun_ammo, machinegun_reserve, rocket_ammo, rocket_reserve]
